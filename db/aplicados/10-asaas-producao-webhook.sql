...
-- ============================================================
-- Produção deixa de ser bloqueada: conta em produção pode ser ativada
-- pela rotina oficial de configuração (só usuário com permissão financeira).
-- O processamento de eventos passa a aceitar também o executor interno
-- (papel de serviço), que é quem entrega os webhooks do Asaas.

-- ---------- estado canônico: produção ativável ----------
...
-- ---------- guard da conta: produção permitida pela rotina ----------
...
-- ---------- configuração oficial: aceita produção ----------
...
-- ---------- resolução de configuração: produção coerente ----------
...
-- ---------- situação da conta: produção ok quando conectada ----------
...
-- ---------- processamento de evento: executor interno também ----------
