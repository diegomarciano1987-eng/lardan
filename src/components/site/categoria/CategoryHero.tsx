...
export function CategoryHero({ categoria }: { categoria: CategoriaDetalhe }) {
  ...
  return (
    <header className="relative overflow-hidden">
      <div className="mx-auto grid max-w-[88rem] items-center gap-12 px-6 pb-16 pt-28 md:min-h-[72vh] md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] md:gap-20 md:pb-24 md:pt-44">
