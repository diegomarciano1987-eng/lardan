...
export type Capability =
  ...
  | "finance.statement.flag"
  | "finance.statement.audit"
  | "finance.dre.view"
  | "finance.import.run"
  ...
  | "candidaturas.tags"
  | "candidaturas.mark_won"
  | "candidaturas.mark_lost"
  | "candidaturas.reopen"
  | "candidaturas.archive"
  | "candidaturas.export"
  | "candidaturas.settings"
  | "candidaturas.pii.view"
  | "registry.view"
  | "registry.manage"
  | "registry.doc.view"
