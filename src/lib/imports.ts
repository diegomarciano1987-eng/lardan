...
export const CAMPOS = [
  ...
  { key: "preco_custo", label: "Preço de custo", obrigatorio: true, alvo: "produto" },
...
const APELIDOS: Record<CampoKey, string[]> = {
  ...
  custo: ["valor de custo", "custo", "valor custo", "custo unitario"],
