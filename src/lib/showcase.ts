...
export const CHECKLIST_LABEL: Record<string, string> = {
  ...
  slug: "Endereço (slug)",
  categoria: "Categoria",
  categoria_nao_publicada: "Categoria ainda fora do ar (publique a categoria primeiro)",
  descricao: "Descrição",
...
export const ROTULO_IMPEDIMENTO: Record<string, string> = {
  ...
  slug_duplicado: "endereço já usado por outra peça",
  subcategoria: "subcategoria",
  subcategoria_invalida: "subcategoria de outra categoria",
  material_bruto: "material bruto",
  peso_bruto: "peso bruto",
  fornecedor_bruto: "fornecedor do bruto",
  custo_bruto: "valor da peça no bruto",
  medidas: "medidas",
  resumo: "resumo",
  cuidados: "cuidados",
  garantia: "garantia",
  seo_titulo: "título para buscadores",
  seo_descricao: "descrição para buscadores",
  variante_ativa: "pelo menos uma variante ativa",
  variante_incompleta: "variante ativa com dados faltando",
};
