...
const GRUPOS: { titulo: string; nota: string; itens: Card[] }[] = [
  ...
  },
  {
    ...
    itens: [
      { label: "Contas e caixas", icon: Wallet, texto: "Onde o dinheiro entra e sai.", to: "/admin/financeiro/contas" },
      { label: "Plano de contas", icon: Landmark, texto: "Classificação contábil das operações.", to: "/admin/financeiro/plano-contas" },
      { label: "Centros de custo", icon: Layers, texto: "A que área cada custo pertence.", to: "/admin/financeiro/centros-custo" },
      { label: "Formas e condições de pagamento", icon: Receipt, texto: "Prazos, parcelas e meios aceitos.", to: "/admin/financeiro/configuracoes" },
