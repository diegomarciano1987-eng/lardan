...
begin
  ...
  with base as (
    ...
    where (_situacao is null or _situacao = ''
      ...
      and (_de is null or (proximo_vencimento is not null and proximo_vencimento >= _de))
      and (_ate is null or (proximo_vencimento is not null and proximo_vencimento <= _ate))
  )
