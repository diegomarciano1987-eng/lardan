...
REVOKE ALL ON FUNCTION public.access_roles_replace(uuid, public.app_role[]) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.access_roles_replace(uuid, public.app_role[]) TO authenticated;